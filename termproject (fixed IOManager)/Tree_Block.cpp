...
Tree_Block::Tree_Block(Array_2d* array_2d, Color c1, Color c2, Color c3) : Big_Block(array_2d){
	this->minX=this->x;
	this->maxX=this->x;
	this->minY=this->y-1;
	this->maxY=this->y+1;
	
	this->v.push_back(new Block(this->array_2d, this->x, this->maxY, c3));
	this->v.push_back(new Block(this->array_2d, this->x, this->y, c1));
	this->v.push_back(new Block(this->array_2d, this->x, this->minY, c2));
}
